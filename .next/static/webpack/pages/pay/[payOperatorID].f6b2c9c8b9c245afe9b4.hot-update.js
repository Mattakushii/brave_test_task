    ...
    switch (fieldName) {
      case 'phone':
        ...
        if (phoneRegexp.test(value)) {
          ...
          isValidPhone = false;
          validationErrors.phone = 'Поле не до';
